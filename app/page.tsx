  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <nav className="border-b border-border/60">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/login"
              className="rounded-md px-4 py-2 font-mono text-sm text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
            >
              Login
            </Link>
            ...
            <Link
              href="/register"
              className="rounded-md border border-primary/40 bg-primary/10 px-4 py-2 font-mono text-sm text-primary transition-colors hover:bg-primary/20"
            >
              Sign Up
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-24 sm:pb-32 sm:pt-32">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              <div className="mb-6 inline-flex items-center gap-2 rounded-md border border-border bg-muted/40 px-3 py-2 font-mono text-xs text-muted-foreground">
                <span className="text-primary">$</span>
                devjournal init
              </div>

              <h1 className="max-w-3xl font-mono text-4xl font-bold leading-tight tracking-tight sm:text-6xl">
                Your code.
                <br />
                Your knowledge.
                <br />
              ...
              <div className="mt-8 flex items-center gap-5 font-mono text-xs text-muted-foreground">
            ...
            <div className="relative">
              <div className="overflow-hidden rounded-xl border border-border bg-card shadow-2xl">
                ...
                <div className="space-y-5 p-5 font-mono text-xs sm:p-7 sm:text-sm">
                  ...
                  <div className="space-y-2 border-l border-border pl-4 text-muted-foreground">
                    <p>
                      <span className="text-primary">✓</span>{" "}
      ...
      <section className="border-t border-border/60">
        <div className="mx-auto max-w-7xl px-6 py-24">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="rounded-xl border border-border bg-card p-5 font-mono text-xs leading-7 shadow-lg sm:p-7">
              <p>
      ...
      <section className="border-t border-border/60 bg-muted/10">
        <div className="mx-auto max-w-4xl px-6 py-24 text-center">
          ...
          <h2 className="mt-6 font-mono text-2xl font-bold sm:text-3xl">
          ...
          <Link
            href="/register"
            className="mt-7 inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3 font-mono text-sm font-medium text-primary-foreground transition-all hover:gap-3 hover:opacity-90"
          >
            $ create-account
            <ArrowRight className="size-4" />
          </Link>
...
function FeatureCard({
  ...
  return (
    <div className="group rounded-xl border border-border/70 bg-card p-6 transition-all duration-200 hover:-translate-y-1 hover:border-primary/30">
